package sam.frampton.parcferme.views
 ...
 * back to top.
 *
 * This workaround checks if the SwipeRefresh layout can still scroll back up. If so, it does not
 * trigger the motionLayout transition.
 *
 * Taken from https://stackoverflow.com/a/59827320
 */
